...
use crate::compiler::parser::object::footnote_reference::footnote_reference_parser;
use crate::compiler::parser::object::inline_babel_call::inline_babel_call_parser;
use crate::compiler::parser::object::inline_source_block::inline_source_block_parser;
use crate::compiler::parser::object::latex_fragment::latex_fragment_parser;
use crate::compiler::parser::object::line_break::line_break_parser;
use crate::compiler::parser::object::link::{
    angle_link_parser, plain_link_parser, regular_link_parser,
};
use crate::compiler::parser::object::r#macro::macro_parser;
...
"##;
        ...
        let radio_targets = parser.get_radio_targets(input);
        let parser = org_file_parser(OrgParserConfig::default());

        let expected_output = r##"OrgFile@0..1933
...
"##;
        assert_eq!(
            get_parser_output_with_state(
                parser,
                input,
                extra::SimpleState(ParserState::new(radio_targets))
            ),
            expected_output
        );
    }
