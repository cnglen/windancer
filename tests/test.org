...
| object kind     | object value               | status |
|-----------------+----------------------------+--------|
| plain text      | just text                  | yes    |
| text markup     | *bold*                     |        |
| entity          | \alpha                     |        |
| latex fragment  | $\sum_{i=1}^{n} i$         |        |
| superscript     | a_1                        |        |
| subscript       | c^{2}                      |        |
| radio link      | radio target in cell       |        |
| plain link      | https://www.foo.bar        |        |
| regular link    | [[target in cell][target link]]                |        |
| angle link      | <mailto:foo@bar.org>       |        |
| macro           | {{{title}}}                |        |
| radio target    | <<<radio target in cell>>> |        |
| target          | <<target in cell>>         |        |
| timestamps      | <1234-04-23>               |        |
|-----------------+----------------------------+--------|
| citation        |                            | N      |
| export snippets |                            | N      |
...
without description [[https://foo.bar]]
...
define three radio targer <<<*bold* target>>> and <<<my radio target>>>  and <<<\alpha>>> and <<<$\alpha$>>>


radio link: this is *bold* target, my radio target, notmyradio target and $\alpha$ and \alpha.
