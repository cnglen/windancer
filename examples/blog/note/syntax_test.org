...
An org-mode document begins an optional */_zeroth_/* section (everything before the first heading), followed by a sequence of headings.
...
The following drawer named d1's content will not appear in expoted html.
:d1:
